            ...
            >
              <Button
                ...
                sx={{
                  ...
                  borderRadius: "20px",
                  background:
                    theme.palette.mode === "light" ? "#DBA39A20" : "#E8A9A920",
                  transition: "all 0.3s ease",
                  whiteSpace: "nowrap",
                  "&:hover": {
                    background:
          ...
          {[
            ...
            <div
              ...
              style={{
                ...
                alignItems: "center",
                minHeight: "100vh",
                padding: isMobile ? "152px 20px 80px" : "112px 0 60px",
